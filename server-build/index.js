import { Buffer as Buffer$1, WasiRequest, WasiResponse } from 'wasi_http';
import { WasiTcpServer } from 'wasi_net';
...
function J$1(a, b, c) {
  var e,
    ...
    k = null,
    h = null;
  if (null != b) for (e in void 0 !== b.ref && (h = b.ref), void 0 !== b.key && (k = "" + b.key), b) H.call(b, e) && !I$1.hasOwnProperty(e) && (d[e] = b[e]);
...
function O$1(a, b, c, e, d) {
  ...
  if (Array.isArray(a)) for (var g = 0; g < a.length; g++) {
    ...
    var f = e + N$1(k, g);
    h += O$1(k, b, c, f, d);
  } else if (f = y(a), "function" === typeof f) for (a = f.call(a), g = 0; !(k = a.next()).done;) k = k.value, f = e + N$1(k, g++), h += O$1(k, b, c, f, d);else if ("object" === k) throw b = "" + a, Error(z$1(31, "[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b));
  return h;
}
function P$1(a, b, c) {
  if (null == a) return a;
...
react_production_min.cloneElement = function (a, b, c) {
  ...
  if (null != b) {
    ...
    for (f in b) H.call(b, f) && !I$1.hasOwnProperty(f) && (e[f] = void 0 === b[f] && void 0 !== g ? g[f] : b[f]);
  }
...
function App(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "App"
  }, /*#__PURE__*/React.createElement("p", null, title), /*#__PURE__*/React.createElement("p", null, description));
}

function handle_client(cs) {
...
function handle_req(s, req) {
  return __async(function* () {
    if (req.uri == '/') {
      const app = server.renderToString( /*#__PURE__*/react.exports.createElement(App, {
        data: {
          "title": "Hello this is the example of Server side rendering in react application via wasm",
